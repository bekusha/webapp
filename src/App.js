...
import "./App.css";
import logowhite from "./images/Path.png";
        ...
        <Link to={"/"}>
          ...
          >
            <path
              ...
              fill={activeMenu === "home" ? "#FC4747" : "#5A698F"}
            />
          </svg>
        </Link>
        <Link to={"movies"}>
          ...
          >
            <path
              ...
              fill={activeMenu === "movies" ? "#FC4747" : "#5A698F"}
            />
          </svg>
        </Link>
        <Link to={"series"}>
          ...
          >
            <path
              ...
              fill={activeMenu === "series" ? "#FC4747" : "#5A698F"}
            />
          </svg>
        </Link>
        <Link to={"bookmarked"}>
          <svg
            className="navs"
            onClick={() => setActiveMenu("bookmarked")}
            width="17"
            height="20"
            viewBox="0 0 17 20"
            fill="none"
          ...
          >
            <path
              ...
              fill={activeMenu === "bookmarked" ? "#FC4747" : "#5A698F"}
            />
          </svg>
        </Link>
